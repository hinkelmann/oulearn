...
module.exports = { // eslint-disable-line
    title: 'Oulearn Javascript Docs',
    require: [
        './src/oulearn/Bundle/AdminBundle/Resources/js/containers/Application/global.scss',
        './src/oulearn/Bundle/AdminBundle/Resources/js/containers/Application/styleguidist.scss',
    ],
    styles: {
        Playground: {
            preview: {
    ...
    sections: [
        {
            name: 'Views',
            sections: (function() {
                const folders = glob.sync('./src/Oulearn/Bundle/*/Resources/js/views/*');
        ...
        },
        {
            name: 'Services',
            sections: (function() {
                const folders = glob.sync('./src/Oulearn/Bundle/*/Resources/js/services/*');
        ...
        },
        {
            name: 'Containers',
            components() {
                let folders = glob.sync('./src/Oulearn/Bundle/*/Resources/js/containers/*');
        ...
        },
        {
            ...
            sections: (function() {
                let folders = glob.sync('./src/Oulearn/Bundle/*/Resources/js/components/*');
